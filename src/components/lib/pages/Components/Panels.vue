      ...
      <div class="col-md-6">
        <card>
          ...
          >
            <tab-pane>
              <span slot="label">
                <i class="tim-icons icon-istanbul" />Home
              </span>
              Collaboratively administrate empowered markets via plug-and-play
              networks. Dynamically procrastinate B2C users after installed base
              benefits.
            ...
            <tab-pane>
              <span slot="label">
                <i class="tim-icons icon-settings" />Settings
              </span>
              Efficiently unleash cross-media information without cross-media
              value. Quickly maximize timely deliverables for real-time schemas.
              <br>
      ...
      <div class="col-md-8 ml-auto mr-auto">
        <card class="card-subcategories card-plain">
          ...
          >
            ...
            <tab-pane>
              <span slot="label">
                <i class="tim-icons icon-bag-16" />Messages
              </span>
              Efficiently unleash cross-media information without cross-media
              value. Quickly maximize timely deliverables for real-time schemas.
              <br>
...
<script>
import { TabPane, Tabs, Collapse, CollapseItem } from "src/components/lib";
