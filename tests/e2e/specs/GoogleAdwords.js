// module.exports = {
//   "Google Adwords: authorization": function (browser) {
//     browser
//       .end()
//     // .url("http://localhost:8080/google-ads")
//     // .waitForElementVisible(".card", 10000)
//     // .assert.urlContains("google-ads")
//   },

//   // "Google Adwords: accounts" : function (browser) {
//   //   browser
//   //     .waitForElementVisible(".card-header", 10000)
...
//   //     .click("#passwordNext")
//   //     .waitForElementVisible("#submit_approve_access", 2000)
